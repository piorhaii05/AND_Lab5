...
public class MainActivity extends AppCompatActivity implements DistributorAdapter.DistributorClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Sử dụng ViewBinding để khởi tạo binding
        binding = ActivityMainBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot()); // Đặt view từ binding
        ...
        fetchAPI();
        userListener(); // Bây giờ binding đã được khởi tạo, không còn lỗi NullPointerException
    }
